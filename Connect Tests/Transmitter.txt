...
public:
	...
	{
		// create sockets
		int UDPsock = socket(AF_INET, SOCK_DGRAM | SOCK_NONBLOCK, IPPROTO_UDP);
		...
		int resultCode = bind(UDPsock, (const sockaddr*)&UDPSocketAddr, (socklen_t)sizeof(UDPSocketAddr));
